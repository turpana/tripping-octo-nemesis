...
$(function() {
  TrippingOctoNemesis = (function() {
    // Private static
    var mainActions = new Actions([
      new Action({ name: '/me' }),
      new Action({ name: '/me/friends' }),
      new Action({ name: '/me/feed' }),
      new Action({ name: '/me/home' })
    ]);
    var appView = new AppView(mainActions);;
    ...
    return function ($, FB, $jit) {
      ...
      // cached dom jquery objects
      var $loginStatus = $('#login-status');
      var $fbApiUI = $('#fb-api-ui-old');
      // Private methods
      ...
      function loadApiUI() {
        ...
        $('#fb-api-me-home').click(function() {
          FB.api('/me/home?limit=50', function (response) { 
            ...
            jitJson.values = [];
            FB.api('/me/home?limit=50&offset=50', function (response) {
